...
directorio_trabajo <- setwd("C:/Users/Javier Ortiz/Desktop/Master Big Data/TFM/TFM-UEMC/Estudio preliminar")
getwd()

macro <- read.table(file="Estudio preliminar/Datos/macro.csv", header=TRUE, sep=",")

train <- read.table(file="Estudio preliminar/Datos/train.csv", header=TRUE, sep=",")

test <- read.table(file="Estudio preliminar/Datos/test.csv", header=TRUE, sep=",")
