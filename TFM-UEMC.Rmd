...
train_sub <- subset(train,select = c(full_sq,life_sq,floor,max_floor,material,build_year,num_room,kitch_sq,state,product_type,sub_area,price_doc))
...
wss <- (nrow(test_macro_mod)-1)*sum(apply(train_sub,2,var))
